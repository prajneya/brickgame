...
def paint_win_screen():
	...
	print(Fore.GREEN + Style.BRIGHT+ Back.WHITE + " YOU WIN ".center(SCREEN)+Style.RESET_ALL)
...
def paint_lose_screen():
	...
	print(Fore.RED + Style.BRIGHT+ Back.WHITE + " YOU LOSE ".center(SCREEN)+Style.RESET_ALL)
